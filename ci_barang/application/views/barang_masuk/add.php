        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url() . 'barangmasuk/addAksi1'; ?>" method="post">
                    ...
                    <div class="row form-group">
                        <label class="col-md-3 text-md-right" for="id_dokumen">Satuan Barang</label>
                        <div class="col-md-9">
                            <div class="input-group">
                                <select name="id_dokumen" id="id_dokumen" class="custom-select" required>
                                    <option value="" selected disabled>Pilih Dokumen Barang</option>
                                    <?php foreach ($masuk as $s) : ?>
                                        <option <?= set_select('id_dokumen', $s['id_dokumen']) ?> value="<?= $s['id_dokumen'] ?>"><?= $s['nama_dokumen'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <div class="input-group-append">
                                    <a class="btn btn-primary" href="<?= base_url('barang/vAddDokumen'); ?>"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
